...
class ReviewAdapter : ListAdapter <CustomerReviewsItem, ReviewAdapter.MyViewHolder> (DIIF_CALLBACK) {
    ...
    companion object {
        val DIIF_CALLBACK = object : DiffUtil.ItemCallback<CustomerReviewsItem> (){
